                      ...
                      children: [
                        ProductProfileCardCard(
                          ontap: () {
                            Get.toNamed(AppRoutes.shop_profile, parameters: {
                              'shop_id':
                                  controller.combinedProductData!.shop.id,
                            });
                          },
                          img:
                              controller.combinedProductData!.shop.logoImageUrl,
                          name: controller.combinedProductData!.shop.name,
                          category:
                              controller.combinedProductData!.shop.category,
                        ),
                        Gap(12),
                        // CachedNetworkImage(
                        //   imageUrl:
                        ...
                        SizedBox(
                          ...
                          child: CarouselSlider(
                            ...
                            items: controller
                                .combinedProductData!.product.images!
                                .map((i) {
                              return Builder(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      controller
                                          .combinedProductData!.product.name!,
                                  ...
                                  Text(
                                    "${controller.combinedProductData!.product.price}" +
                                        "AED".tr,
                                    style: const TextStyle(
                                      fontFamily: "Poppins",
                                      fontSize: 20,
                              ...
                              Text(
                                controller
                                    .combinedProductData!.product.description
                                    .toString(),
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: 12,
