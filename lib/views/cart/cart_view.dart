                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Container(
                                ...
                                width : Get.width* 0.4,
                                child: Text('Plaid Flap Pocket Drop Shoulder Coat',
                          ...
                          Padding(
                            ...
                            child: Text('Size: M', style: TextStyle(color: Colors.grey,)),
                          ),
                          Padding(
                             padding: const EdgeInsets.only(left: 10.0, top: 65),
                            child: Row(
                                ...
                                Container(
                                  ...
                                  child: InputQty(
                                      decoration: QtyDecorationProps(
                                          minusBtn: SvgPicture.asset('assets/images/minus.svg'),
                                          plusBtn: SvgPicture.asset('assets/images/plus.svg'),
                                          isBordered: false,
